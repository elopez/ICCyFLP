...
\begin{homeworkProblem}[14]
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \end{aligned}\]
        Para poder luego operar de forma más sencilla, se expande
        $\rho^{AB}$ en función de $\ket{0}$ y $\ket{1}$:
        \[\begin{aligned}
        \rho^{AB} &= \nicefrac{3}{16} \dyad{01} +
...
\begin{homeworkProblem}[16]
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        A su vez, $\textrm{tr}\left(\left(\rho^{0}\right)^{2}\right) = \textrm{tr}\left(\left(\nicefrac{1}{2} \dyad{0} + \nicefrac{1}{2} \dyad{1}\right) \left(\nicefrac{1}{2} \dyad{0} + \nicefrac{1}{2} \dyad{1}\right)\right)
            = \textrm{tr}\left(\nicefrac{1}{4} \dyad{0} + \nicefrac{1}{4} \dyad{1}\right) = \nicefrac{1}{2}$
        ...
        $\textrm{tr}\left(\left(\rho^{0}\right)^{2}\right) = \textrm{tr}\left(\left(\nicefrac{1}{2} \dyad{+} + \nicefrac{1}{2} \dyad{-}\right) \left(\nicefrac{1}{2} \dyad{+} + \nicefrac{1}{2} \dyad{-}\right)\right)
            = \textrm{tr}\left(\nicefrac{1}{4} \dyad{+} + \nicefrac{1}{4} \dyad{-}\right) = \nicefrac{1}{2} < 1$

        Por lo tanto, $\rho$ nuevamente está enredado.

        \item $\rho^{0} = \left(\nicefrac{1}{\sqrt{3}}\right)^{2} \; (\dyad{+} + \dyad{+} + \dyad{-})
                        = \nicefrac{2}{3} \dyad{+} + \nicefrac{1}{3} \dyad{-}$

        $\textrm{tr}\left(\left(\rho^{0}\right)^{2}\right) = \textrm{tr}\left(\left(\nicefrac{2}{3} \dyad{+} + \nicefrac{1}{3} \dyad{-}\right) \left(\nicefrac{2}{3} \dyad{+} + \nicefrac{1}{3} \dyad{-}\right)\right)
            = \textrm{tr}\left(\nicefrac{4}{9} \dyad{+} + \nicefrac{1}{9} \dyad{-}\right) = \nicefrac{5}{9} < 1$
